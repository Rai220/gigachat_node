...
import { APIUserAbortError } from 'gigachat';
import { Headers } from 'gigachat/core';
...
describe('instantiate azure client', () => {
  ...
  describe('defaultHeaders', () => {
    const client = new AzureGigaChat({
  ...
  describe('baseUrl', () => {
    ...
    test('explicit option', () => {
      const client = new AzureGigaChat({ baseURL: 'https://example.com', apiKey: 'My API Key', apiVersion });
      expect(client.baseURL).toEqual('https://example.com');
    });

    test('env variable', () => {
      process.env['OPENAI_BASE_URL'] = 'https://example.com/from_env';
      const client = new AzureGigaChat({ apiKey: 'My API Key', apiVersion });
      expect(client.baseURL).toEqual('https://example.com/from_env');
    });

    test('empty baseUrl/endpoint env variable', () => {
      process.env['OPENAI_BASE_URL'] = ''; // empty
      expect(() => new AzureGigaChat({ apiKey: 'My API Key', apiVersion })).toThrow(
  ...
  test('maxRetries option is correctly set', () => {
    ...
    // default
    const client2 = new AzureGigaChat({ baseURL: 'https://example.com', apiKey: 'My API Key', apiVersion });
  ...
  test('with endpoint', () => {
    const client = new AzureGigaChat({ endpoint: 'https://example.com', apiKey: 'My API Key', apiVersion });
    expect(client.baseURL).toEqual('https://example.com/gigachat');
  });
  ...
  describe('model to deployment mapping', function () {
    ...
    describe('with client-level deployment', function () {
      ...
      test('handles batch', async () => {
        ...
        expect(url).toStrictEqual(`https://example.com/gigachat/batches?api-version=${apiVersion}`);
      });
      ...
      test('handles completions', async () => {
        ...
        expect(url).toStrictEqual(
          `https://example.com/gigachat/deployments/${deployment}/completions?api-version=${apiVersion}`,
        );
      });
      ...
      test('handles chat completions', async () => {
        ...
        expect(url).toStrictEqual(
          `https://example.com/gigachat/deployments/${deployment}/chat/completions?api-version=${apiVersion}`,
        );
      });
      ...
      test('handles embeddings', async () => {
        ...
        expect(url).toStrictEqual(
          `https://example.com/gigachat/deployments/${deployment}/embeddings?api-version=${apiVersion}`,
        );
      });
      ...
      test('handles audio translations', async () => {
        ...
        expect(url).toStrictEqual(
          `https://example.com/gigachat/deployments/${deployment}/audio/translations?api-version=${apiVersion}`,
        );
      });
      ...
      test('handles audio transcriptions', async () => {
        ...
        expect(url).toStrictEqual(
          `https://example.com/gigachat/deployments/${deployment}/audio/transcriptions?api-version=${apiVersion}`,
        );
      });
      ...
      test('handles text to speech', async () => {
        ...
        expect(url).toStrictEqual(
          `https://example.com/gigachat/deployments/${deployment}/audio/speech?api-version=${apiVersion}`,
        );
      ...
      test('handles image generation', async () => {
        ...
        expect(url).toStrictEqual(
          `https://example.com/gigachat/deployments/${deployment}/images/generations?api-version=${apiVersion}`,
        );
      });
      ...
      test('handles assistants', async () => {
        ...
        expect(url).toStrictEqual(`https://example.com/gigachat/assistants?api-version=${apiVersion}`);
      });
      ...
      test('handles files', async () => {
        ...
        expect(url).toStrictEqual(`https://example.com/gigachat/files?api-version=${apiVersion}`);
      });
      ...
      test('handles fine tuning', async () => {
        ...
        expect(url).toStrictEqual(`https://example.com/gigachat/fine_tuning/jobs?api-version=${apiVersion}`);
      });
    });
    ...
    describe('with no client-level deployment', function () {
      ...
      test('Audio translations is not handled', async () => {
        ...
        expect(url).toStrictEqual(`https://example.com/gigachat/audio/translations?api-version=${apiVersion}`);
      });
      ...
      test('Audio transcriptions is not handled', async () => {
        ...
        expect(url).toStrictEqual(
          `https://example.com/gigachat/audio/transcriptions?api-version=${apiVersion}`,
        );
      });
