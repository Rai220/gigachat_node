...
describe('.parse()', () => {
  describe('zod', () => {
    it('deserialises response_format', async () => {
      const completion = await makeSnapshotRequest((gigachat) =>
        gigachat.beta.chat.completions.parse({
    ...
    test('merged schemas', async () => {
          ...
          gigachat.beta.chat.completions.parse({
            ...
            messages: [
              ...
              },
              {
                role: 'user',
                content:
                  'jane doe, born nov 16, engineer at gigachat, jane@gigachat.com. john smith, born march 1, enigneer at gigachat, john@gigachat.com',
              },
            ],
      ...
      expect(completion.choices[0]?.message).toMatchInlineSnapshot(`
        {
          "content": "{"person1":{"name":"Jane Doe","phone_number":".","roles":["other"],"description":"Engineer at GigaChat, born Nov 16, contact email: jane@gigachat.com"},"person2":{"name":"John Smith","phone_number":"john@gigachat.com","differentField":"Engineer at GigaChat, born March 1."}}",
          "parsed": {
            "person1": {
              "description": "Engineer at GigaChat, born Nov 16, contact email: jane@gigachat.com",
              "name": "Jane Doe",
              "phone_number": ".",
              "roles": [
                "other",
            ...
            "person2": {
              "differentField": "Engineer at GigaChat, born March 1.",
              "name": "John Smith",
              "phone_number": "john@gigachat.com",
            },
          },
          "refusal": null,
          "role": "assistant",
