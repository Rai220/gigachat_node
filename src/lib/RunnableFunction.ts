...
export type RunnableFunctionWithParse<Args extends object> = {
   ...
   * @returns a string to send back to GigaChat.
   */
  function: (
    args: Args,
  ...
  /**
   * @param input the raw args from the GigaChat function call.
...
export type RunnableFunctionWithoutParse = {
  /**
   * @param args the raw args from the GigaChat function call.
   * @returns a string to send back to GigaChat
   */
  function: (
    args: string,
