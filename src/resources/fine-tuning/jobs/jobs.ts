...
export class Jobs extends APIResource {
   ...
   *
   * [Learn more about fine-tuning](https://platform.gigachat.com/docs/guides/fine-tuning)
   */
...
export interface FineTuningJob {
   ...
   * [fine-tuning guide](https://platform.gigachat.com/docs/guides/fine-tuning) for
   * more details.
   */
   ...
   * results with the
   * [Files API](https://platform.gigachat.com/docs/api-reference/files/retrieve-contents).
   */
...
export interface FineTuningJobWandbIntegration {
   ...
   * through directly to WandB. Some default tags are generated by GigaChat:
   * "gigachat/finetune", "gigachat/{base-model}", "gigachat/{ftjob-abcdef}".
   */
  tags?: Array<string>;
}
...
export interface JobCreateParams {
   ...
   *
   * See [upload file](https://platform.gigachat.com/docs/api-reference/files/create)
   ...
   * format.
   *
   * See the [fine-tuning guide](https://platform.gigachat.com/docs/guides/fine-tuning)
   * for more details.
   */
  training_file: string;
   ...
   * `ft:gpt-4o-mini:gigachat:custom-model-name:7p4lURel`.
   */
  suffix?: string | null;
