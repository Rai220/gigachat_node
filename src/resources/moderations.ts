...
export class Moderations extends APIResource {
   ...
   * the [moderation guide](https://platform.gigachat.com/docs/guides/moderation).
   */
  create(
...
export interface ModerationCreateParams {
   ...
   * [the moderation guide](https://platform.gigachat.com/docs/guides/moderation), and
   * learn about available models
   * [here](https://platform.gigachat.com/docs/models#moderation).
   */
