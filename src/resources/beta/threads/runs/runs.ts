...
export class Runs extends APIResource {
   ...
   * https://platform.gigachat.com/docs/assistants/how-it-works/runs-and-run-steps
   */
  async createAndPoll(
    threadId: string,
      ...
      switch (run.status) {
        ...
        case 'cancelling':
          ...
          if (options?.pollIntervalMs) {
            ...
            const headerInterval = response.headers.get('gigachat-poll-after-ms');
            if (headerInterval) {
...
export interface RequiredActionFunctionToolCall {
   ...
   * [Submit tool outputs to run](https://platform.gigachat.com/docs/api-reference/runs/submitToolOutputs)
   * endpoint.
   */
  id: string;
...
export interface Run {
  ...
  /**
   * The ID of the
   * [assistant](https://platform.gigachat.com/docs/api-reference/assistants) used for
  ...
  /**
   * Whether to enable
   * [parallel function calling](https://platform.gigachat.com/docs/guides/function-calling#configuring-parallel-function-calling)
   * during tool use.
   */
  ...
  /**
   * The ID of the [thread](https://platform.gigachat.com/docs/api-reference/threads)
...
export interface RunCreateParamsBase {
   ...
   * [assistant](https://platform.gigachat.com/docs/api-reference/assistants) to use to
   * execute this run.
   */
  assistant_id: string;
   ...
   * [instructions](https://platform.gigachat.com/docs/api-reference/assistants/createAssistant)
  ...
  /**
   * Body param: The ID of the
   * [Model](https://platform.gigachat.com/docs/api-reference/models) to be used to
...
export interface RunCreateAndPollParams {
  ...
  /**
   * The ID of the [Model](https://platform.gigachat.com/docs/api-reference/models) to
